  ...
  const NAV: NavGroup[] = useMemo(() => {
    return [
      ...
      // ✅ YANGI: Ma'lumotlar (submenu bilan)
      {
        ...
        icon: IconDatabase,
        children: [
          { href: MALUMOTLAR.adminlar, label:  "Adminlar" },
          { href: MALUMOTLAR.xodimlar, label: "Xodimlar" },
          {
            href: MALUMOTLAR.foydalanuvchilar,
            label:  "Foydalanuvchilar",
          },
          { href: MALUMOTLAR.magazinlar, label: "Magazinlar" },
          { href: MALUMOTLAR.skladlar, label: "Skladlar" },
          { href: MALUMOTLAR.ofislar, label: "Ofislar" },
          { href: MALUMOTLAR.hududlar, label:  "Hududlar" },
          { href: MALUMOTLAR.umumiy, label:  "Umumiy" },
        ],
      },
